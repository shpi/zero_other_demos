...
while DISPLAY.loop_running():
 ...
 if (gpio.input(26)):
  ...
  if (x1 - 80) < x3 and x3  < (x1 + 80):
    if (y1 - 80) < y3 and y3  < (y1 + 80):
     
     x1, y1 = x3, y3
     #line3 = pi3d.Lines(vertices=[(0,0,2),(x2,y2,2)], line_width=2, strip=True)
     degree = int(degrees(atan(x1/y1)))
